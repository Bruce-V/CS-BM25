...
mytopicdb=myclient["cs2018_10"]
mydata=mytopicdb["cs2018_score_10"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_10_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_kit*bm25_kit_score+idf_l576p*bm25_l576p_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(kit_score):idf_kit},{str(l576p_score):idf_l576p}]
