...
mytopicdb=myclient["cs2018_47"]
mydata=mytopicdb["cs2018_score_47"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_47_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_ele_3 = log((13670358 - 5017 + 0.5) / (5017 + 0.5), 10)
    idf_ele_4 = log((13670358 - 8236 + 0.5) / (8236 + 0.5), 10)
    ...
    idf_eleM_4 = log((25389659 - 8236 + 0.5) / (8236 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score = idf_prostate * bm25_prostate_score + idf_pten * bm25_pten_score

                idf_para = [{str(prostate_score): idf_prostate}, {str(pten_score): idf_pten}]
                ...
                for ele in ChemicalNameList:
                    if 'Prostate-Specific Antigen' == ele['NameOfSubstance']:
                        ...
                        break
                for ele in ChemicalNameList:
                    if 'PTEN protein, human' == ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_3
                        break
                for ele in ChemicalNameList:
                    if 'PTEN Phosphohydrolase' == ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_4
                        break
                for ele in ChemicalNameList:
