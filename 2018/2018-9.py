...
mytopicdb=myclient["cs2018_9"]
mydata=mytopicdb["cs2018_score_9"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_9_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_q61l = log((29138919 - 138 + 0.5) / (138 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                for key in wordfreq:
                    key1 = cop.sub('', key)
                    if 'q61l' in key1:
                        q61l_score = q61l_score + wordfreq[key]
                ...
                bm25_q61l_score = (((k1+1)*q61l_score)/((k1*(b1+(1-b1)*(len_freq/85)))+q61l_score))


                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_nras*bm25_nras_score+idf_q61l*bm25_q61l_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(nras_score):idf_nras},{str(q61l_score):idf_q61l}]
