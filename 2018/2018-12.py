...
mytopicdb=myclient["cs2018_12"]
mydata=mytopicdb["cs2018_score_12"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_12_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_k642e = log((29138919 - 12 + 0.5) / (12 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                for key in wordfreq:
                    key1 = cop.sub('', key)
                    if 'k642e' in key1:
                        k642e_score = k642e_score + wordfreq[key]
                ...
                bm25_k642e_score = (((k1+1)*k642e_score)/((k1*(b1+(1-b1)*(len_freq/85)))+k642e_score))


                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_kit*bm25_kit_score+idf_k642e*bm25_k642e_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(kit_score):idf_kit},{str(k642e_score):idf_k642e}]
            ...
            # ---------------共现分析化学-------------------#
                ...
                if len(melanoma) != 0 and melanoma[0]:
                    for ele in ChemicalNameList:
                        if 'K642E' in ele['NameOfSubstance']:
                            gx1 = idf_k642e
                            break
             ...
             # ---------------共现分析医学主题词-------------------#
                ...
                if len(melanoma) != 0 and melanoma[0]:
                    for eleM in MeshHeadingNameList:
                        if 'K642E' in eleM['MeshHeadingName']:
                            gx = idf_k642e
                            break
