...
mytopicdb=myclient["cs2018_1"]
mydata=mytopicdb["cs2018_score_1"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_1_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_braf*bm25_braf_score+idf_v600e*bm25_v600e_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(braf_score):idf_braf},{str(v600e_score):idf_v600e}]
            ...
            # ---------------共现分析关键字-------------------#
             ...
             # ---------------共现分析医学主题词-------------------#
                ...
                for eleM in MeshHeadingNameList:
                    if 'Mutation' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_1
                        break
                for eleM in MeshHeadingNameList:
