...
mytopicdb=myclient["cs2018_23"]
mydata=mytopicdb["cs2018_score_23"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_23_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_pten*bm25_pten_score+idf_loss*bm25_loss_score+idf_function*bm25_function_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(pten_score):idf_pten},{str(loss_score):idf_loss},{str(function_score):idf_function}]
