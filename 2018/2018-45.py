...
mytopicdb=myclient["cs2018_45"]
mydata=mytopicdb["cs2018_score_45"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_45_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_eleM_1 = log((25389659 - 46290 + 0.5) / (46290 + 0.5), 10)
    idf_eleM_2 = log((25389659 - 7221 + 0.5) / (7221+ 0.5), 10)
    idf_eleM_3 = log((25389659 - 46290 + 0.5) / (46290 + 0.5), 10)
    idf_eleM_4 = log((25389659 - 396072 + 0.5) / (396072 + 0.5), 10)
    ...
    idf_eleK_1 = log((5435471 - 39838 + 0.5) / (39838 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_thyroid*bm25_thyroid_score+idf_braf*bm25_braf_score

                idf_para=[{str(thyroid_score):idf_thyroid},{str(braf_score):idf_braf}]

                # ---------------共现分析摘要-------------------#
                if len(thyroid) != 0 and thyroid[0]:
                    for key in wordfreq:
                        key = cop.sub('', key)
                        if 'braf' == key:
                            gx = idf_braf
