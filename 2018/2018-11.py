...
mytopicdb=myclient["cs2018_11"]
mydata=mytopicdb["cs2018_score_11"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_11_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_eleM_8 = log((25389659 - 2242 + 0.5) / (2242 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_kit*bm25_kit_score+idf_l576p*bm25_l576p_score+idf_amplification*bm25_amplification_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(kit_score):idf_kit},{str(l576p_score):idf_l576p},{str(amplification_score):idf_amplification}]
             ...
             # ---------------共现分析医学主题词-------------------#
                ...
                for ele in ChemicalNameList:
                    if 'Imatinib Mesylate' == ele['NameOfSubstance']:
                        ...
                        break
                for ele in ChemicalNameList:
                    if 'Receptor, Platelet-Derived Growth Factor alpha' in ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_3
                        break
