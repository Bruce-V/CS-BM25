...
mytopicdb=myclient["cs2018_36"]
mydata=mytopicdb["cs2018_score_36"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_36_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_ele_2 = log((13670358 - 8455+ 0.5) / (8455 + 0.5), 10)
    idf_ele_3 = log((13670358 - 22004 + 0.5) / (22004 + 0.5), 10)
    idf_ele_4 = log((13670358 - 22 + 0.5) / (22 + 0.5), 10)
    idf_ele_5 = log((13670358 - 24866 + 0.5) / (24866 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_lung*bm25_lung_score+idf_erbb2*bm25_erbb2_score

                idf_para=[{str(lung_score):idf_lung},{str(erbb2_score):idf_erbb2}]
