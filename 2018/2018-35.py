...
mytopicdb=myclient["cs2018_35"]
mydata=mytopicdb["cs2018_score_35"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_35_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_cdkn2a = log((29138919 - 48503 + 0.5) / (48503 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_breast*bm25_breast_score+idf_cdkn2a*bm25_cdkn2a_score

                idf_para=[{str(breast_score):idf_breast},{str(cdkn2a_score):idf_cdkn2a}]
