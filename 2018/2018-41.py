...
mytopicdb=myclient["cs2018_41"]
mydata=mytopicdb["cs2018_score_41"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_41_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_papillary*bm25_papillary_score+idf_thyroid*bm25_thyroid_score+idf_carcinoma*bm25_carcinoma_score+idf_ntrk1*bm25_ntrk1_score

                idf_para=[{str(papillary_score):idf_papillary},{str(thyroid_score):idf_thyroid},{str(carcinoma_score):idf_carcinoma},{str(ntrk1_score):idf_ntrk1}]
