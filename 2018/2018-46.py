...
mytopicdb=myclient["cs2018_46"]
mydata=mytopicdb["cs2018_score_46"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_46_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_ele_3 = log((13670358 - 993 + 0.5) / (993 + 0.5), 10)
    ...
    idf_eleM_2 = log((25389659 - 209682 + 0.5) / (209682+ 0.5), 10)
    idf_eleM_3 = log((25389659 - 0 + 0.5) / (0 + 0.5), 10)
    idf_eleM_4 = log((25389659 - 2126 + 0.5) / (2126 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score = idf_lung * bm25_lung_score + idf_fgfr1 * bm25_fgfr1_score

                idf_para = [{str(lung_score): idf_lung}, {str(fgfr1_score): idf_fgfr1}]
                ...
                for ele in ChemicalNameList:
                    if 'Lung Neoplasms' == ele['NameOfSubstance']:
                        ...
                        break
                for ele in ChemicalNameList:
                    if 'Lung' == ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_2
                        break
                for ele in ChemicalNameList:
                    if 'FGFR1 protein, human' == ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_3
                        break
                for ele in ChemicalNameList:
                ...
                for eleM in MeshHeadingNameList:
                    if 'Lung Neoplasms' == eleM['MeshHeadingName']:
                        ...
                        break
                for eleM in MeshHeadingNameList:
                    if 'Lung' == eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_2
                        break
                for eleM in MeshHeadingNameList:
                    if 'FGFR1 protein, human' == eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_3
                        break
                for eleM in MeshHeadingNameList:
