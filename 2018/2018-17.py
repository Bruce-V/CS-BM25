...
mytopicdb=myclient["cs2018_17"]
mydata=mytopicdb["cs2018_score_17"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_17_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_eleM_1 = log((25389659 - 15106 + 0.5) / (15106 + 0.5), 10)
    idf_eleM_2 = log((25389659 - 8277 + 0.5) / (8277 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_tp53*bm25_tp53_score+idf_loss*bm25_loss_score+idf_function*bm25_function_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(tp53_score):idf_tp53},{str(loss_score):idf_loss},{str(function_score):idf_function}]
             ...
             # ---------------共现分析医学主题词-------------------#
                ...
                for ele in ChemicalNameList:
                    if 'Genes, p53' == ele['NameOfSubstance']:
                        ...
                        break
                for ele in ChemicalNameList:
                    if 'Loss of Heterozygosity' == ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_2
                        break
                ...
                for eleM in MeshHeadingNameList:
                    if 'Genes, p53' == eleM['MeshHeadingName']:
                        ...
                        break
                for eleM in MeshHeadingNameList:
                    if 'Loss of Heterozygosity' == eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_2
                        break
                for eleM in MeshHeadingNameList:
