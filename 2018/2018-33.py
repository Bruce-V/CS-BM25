...
mytopicdb=myclient["cs2018_33"]
mydata=mytopicdb["cs2018_score_33"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_33_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_gastric*bm25_gastric_score+idf_egfr*bm25_egfr_score

                idf_para=[{str(gastric_score):idf_gastric},{str(egfr_score):idf_egfr}]
