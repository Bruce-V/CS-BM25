...
mytopicdb=myclient["cs2018_20"]
mydata=mytopicdb["cs2018_score_20"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_20_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_eleM_1 = log((25389659 - 391874 + 0.5) / (391874 + 0.5), 10)
    idf_eleM_2 = log((25389659 - 396072 + 0.5) / (396072 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_tumor*bm25_tumor_score+idf_high*bm25_high_score+idf_mutational*bm25_mutational_score+idf_burden*bm25_burden_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(tumor_score):idf_tumor},{str(high_score):idf_high},{str(mutational_score):idf_mutational},{str(burden_score):idf_burden}]
