...
mytopicdb=myclient["cs2018_18"]
mydata=mytopicdb["cs2018_score_18"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_18_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_membranous = log((29138919 - 27999 + 0.5) / (27999 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                for key in wordfreq:
                    key1 = cop.sub('', key)
                    if 'membranous' in key1:
                        membranous_score = membranous_score + wordfreq[key]
                for key in wordfreq:
                    key1 = cop.sub('', key)
                    if 'pdl1' in key1:
                ...
                bm25_membranous_score = (((k1 + 1) * membranous_score) / ((k1 * (b1 + (1 - b1) * (len_freq / 85))) + membranous_score))
                ...
                bm25_ab_score =idf_melanoma*bm25_melanoma_score+idf_tumor*bm25_tumor_score+idf_cell*bm25_cell_score+idf_membranous*bm25_membranous_score+idf_pdl1*bm25_pdl1_score+idf_expression*bm25_expression_score

                idf_para=[{str(melanoma_score):idf_melanoma},{str(tumor_score):idf_tumor},{str(cell_score):idf_cell},{str(membranous_score):idf_membranous},{str(pdl1_score):idf_pdl1},{str(expression_score):idf_expression}]
             ...
             # ---------------共现分析医学主题词-------------------#
                ...
                for ele in ChemicalNameList:
                    if 'B7-H1 Antigen' == ele['NameOfSubstance']:
                        ...
                        break
                for ele in ChemicalNameList:
                    if 'Cell Count' == ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_3
                        break
                for ele in ChemicalNameList:
                    if 'Membranes' == ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_4
                        break
                ...
                for eleM in MeshHeadingNameList:
                    if 'Skin Neoplasms' == eleM['MeshHeadingName']:
                        ...
                        break
                for eleM in MeshHeadingNameList:
                    if 'Cell Count' == eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_4
                        break
                ...
                for eleM in MeshHeadingNameList:
                    if 'Middle Aged' == eleM['MeshHeadingName']:
                        ...
                        break
                for eleM in MeshHeadingNameList:
                    if 'Membranes' == eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_8
                        break
