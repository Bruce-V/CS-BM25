...
mytopicdb=myclient["cs2018_49"]
mydata=mytopicdb["cs2018_score_49"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2018_score_49_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_ele_2 = log((13670358 - 5676 + 0.5) / (5676 + 0.5), 10)
    ...
    idf_eleM_2 = log((25389659 - 5676 + 0.5) / (5676 + 0.5), 10)
    ...
    idf_eleM_7 = log((25389659 - 1088794 + 0.5) / (1088794 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score =idf_acute*bm25_acute_score+idf_myeloid*bm25_myeloid_score+idf_leukemia*bm25_leukemia_score+idf_idh1*bm25_idh1_score

                idf_para=[{str(acute_score):idf_acute},{str(myeloid_score):idf_myeloid},{str(leukemia_score):idf_leukemia},{str(idh1_score):idf_idh1}]
             ...
             # ---------------共现分析医学主题词-------------------#
                ...
                for eleM in MeshHeadingNameList:
                    if 'Male' in eleM['MeshHeadingName']:
                        ...
                        break
                for eleM in MeshHeadingNameList:
                    if 'Infant' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_7
                        break
