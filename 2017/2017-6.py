...
mytopicdb=myclient["cs2017_6"]
mydata=mytopicdb["cs2017_score_6"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2017_score_6_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_eleM_4 = log((25389659 - 113103 + 0.5) / (113103 + 0.5), 10)
    idf_eleM_5 = log((25389659 - 7221 + 0.5) / (7221 + 0.5), 10)
    idf_eleM_6 = log((25389659 - 46290 + 0.5) / (46290 + 0.5), 10)
    ...
    idf_eleK_3 = log((5435471 - 2 + 0.5) / (2 + 0.5), 10)
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                for key in wordfreq:
                    key1 = cop.sub('', key)
                    if 'q61k' in key1:
                        q61k_score = q61k_score + wordfreq[key]
                ...
                if len(melanoma) != 0 and melanoma[0]:
                        for ele in ChemicalNameList:
                            if 'Q61K' in ele['NameOfSubstance']:
                                gx2 = idf_q61k
                                break
                ...
                if len(melanoma) != 0 and melanoma[0]:
                        for eleM in MeshHeadingNameList:
                            if 'Q61K' in eleM['MeshHeadingName']:
                                gx2 = idf_q61k
                                break
                ...
                bm25_q61k_score = (((k1 + 1) * q61k_score) / ((k1 * (b1 + (1 - b1) * (len_freq / 83))) + q61k_score))


                bm25_ab_score = idf_melanoma * bm25_melanoma_score + idf_nras * bm25_nras_score + idf_q61k * bm25_q61k_score

                idf_para = [{str(melanoma_score): idf_melanoma}, {str(nras_score): idf_nras},
                            {str(q61k_score): idf_q61k}]
