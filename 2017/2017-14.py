...
mytopicdb=myclient["cs2017_14"]
mydata=mytopicdb["cs2017_score_14"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2017_score_14_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_ele_1 = log((13670358 - 1130 + 0.5) / (1130 + 0.5), 10)
    ...
    idf_eleM_5 = log((25389659 - 36507 + 0.5) / (36507 + 0.5), 10)
    idf_eleM_6 = log((25389659 - 10185 + 0.5) / (10185 + 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
            ...
            # ---------------共现分析关键字-------------------#
                ...
                bm25_ab_score = idf_cholangiocarcinoma * bm25_cholangiocarcinoma_score + idf_idh1 * bm25_idh1_score + idf_r132h * bm25_r132h_score

                idf_para = [{str(cholangiocarcinoma_score): idf_cholangiocarcinoma}, {str(idh1_score): idf_idh1},
