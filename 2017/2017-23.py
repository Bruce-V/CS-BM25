...
mytopicdb=myclient["cs2017_23"]
mydata=mytopicdb["cs2017_score_23"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2017_score_23_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_ele_4 = log((13670358 - 5017 + 0.5) / (5017 + 0.5), 10)

    idf_eleM_1 = log((25389659 - 268832 + 0.5) / (268832 + 0.5), 10)
    idf_eleM_2 = log((25389659 - 7755 + 0.5) / (7755 + 0.5), 10)
    idf_eleM_3 = log((25389659 - 8236 + 0.5) / (8236 + 0.5), 10)
    idf_eleM_4 = log((25389659 - 8277 + 0.5) / (8277 + 0.5), 10)
    idf_eleM_5 = log((25389659 - 0 + 0.5) / (0 + 0.5), 10)
    idf_eleM_6 = log((25389659 - 0 + 0.5) / (0 + 0.5), 10)
    idf_eleM_7 = log((25389659 - 109126 + 0.5) / (109126 + 0.5), 10)
    idf_eleM_8 = log((25389659 - 161569 + 0.5) / (161569 + 0.5), 10)
    idf_eleM_9 = log((25389659 - 17437618 + 0.5) / (17437618 + 0.5), 10)
    idf_eleM_10 = log((25389659 - 8104149 + 0.5) / (8104149 + 0.5), 10)
    idf_eleM_11 = log((25389659 - 2842020 + 0.5) / (2842020 + 0.5), 10)
    idf_eleM_12 = log((25389659 - 4029038 + 0.5) / (4029038 + 0.5), 10)
    idf_eleM_13 = log((25389659 - 4785026 + 0.5) / (4785026 + 0.5), 10)

    idf_eleK_1 = log((5435471 - 56304 + 0.5) / (1468 + 0.5), 10)
    idf_eleK_2 = log((5435471 - 2117 + 0.5) / (29226 + 0.5), 10)
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
            ...
            # ---------------共现分析关键字-------------------#
                ...
                bm25_ab_score = idf_breast * bm25_breast_score + idf_pten * bm25_pten_score + idf_loss * bm25_loss_score

                idf_para = [{str(breast_score): idf_breast}, {str(pten_score): idf_pten},
                            {str(loss_score): idf_loss}]
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                    if 'PTEN' == ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_1
                        break
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                ...
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                    if 'Loss of Heterozygosity' in ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_3
                        break
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                ...
                for eleM in MeshHeadingNameList:
                    # if re.findall(r'(Melanoma|Proto-Oncogene Proteins B-raf|Humans|Neoplasms|Neoplasm|Male|Mutation|Mutational)',eleM['MeshHeadingName']):
                    if 'Mastectomy, Segmental' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_2
                        break
                for eleM in MeshHeadingNameList:
                    # if re.findall(r'(Melanoma|Proto-Oncogene Proteins B-raf|Humans|Neoplasms|Neoplasm|Male|Mutation|Mutational)',eleM['MeshHeadingName']):
                ...
                for eleM in MeshHeadingNameList:
                    # if re.findall(r'(Melanoma|Proto-Oncogene Proteins B-raf|Humans|Neoplasms|Neoplasm|Male|Mutation|Mutational)',eleM['MeshHeadingName']):
                    if 'Loss of Heterozygosity' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_4
                        break
                for eleM in MeshHeadingNameList:
                    # if re.findall(r'(Melanoma|Proto-Oncogene Proteins B-raf|Humans|Neoplasms|Neoplasm|Male|Mutation|Mutational)',eleM['MeshHeadingName']):
                    if 'PTEN' == eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_5
                        break
                for eleM in MeshHeadingNameList:
                    # if re.findall(r'(Melanoma|Proto-Oncogene Proteins B-raf|Humans|Neoplasms|Neoplasm|Male|Mutation|Mutational)',eleM['MeshHeadingName']):
                    if 'PTEN protein, human' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_6
                        break
                for eleM in MeshHeadingNameList:
                    # if re.findall(r'(Melanoma|Proto-Oncogene Proteins B-raf|Humans|Neoplasms|Neoplasm|Male|Mutation|Mutational)',eleM['MeshHeadingName']):
                    if 'Heart Failure' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_7
                        break
                for eleM in MeshHeadingNameList:
                    # if re.findall(r'(Melanoma|Proto-Oncogene Proteins B-raf|Humans|Neoplasms|Neoplasm|Male|Mutation|Mutational)',eleM['MeshHeadingName']):
                    if 'Myocardial Infarction' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_8
                        break
                for eleM in MeshHeadingNameList:
                    # if re.findall(r'(Melanoma|Proto-Oncogene Proteins B-raf|Humans|Neoplasms|Neoplasm|Male|Mutation|Mutational)',eleM['MeshHeadingName']):
...
def count(mysort,mycount,topic):
    ...
    for x in mysort.find({},
                         {'PMID', 'ab_score', 'idf_para', 'cmk_len', 'cmk_freq', 'bm25_cmk_score', 'gx', 'bm25_score',
                          'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'}).limit(4737):
        kk = 0
