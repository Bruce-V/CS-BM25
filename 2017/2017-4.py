...
mytopicdb=myclient["cs2017_4"]
mydata=mytopicdb["cs2017_score_4"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2017_score_4_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_q171= log((29138919 - 0 + 0.5) / (0 + 0.5), 10)
    idf_amplification = log((29138919 - 110630 + 0.5) / (110630 + 0.5), 10)

    idf_ele_1 = log((13670358 - 1026 + 0.5) / (1026 + 0.5), 10)
    idf_ele_2 = log((13670358 - 9102 + 0.5) / (9102 + 0.5), 10)
    idf_ele_3 = log((13670358 - 0 + 0.5) / (0 + 0.5), 10)
    idf_ele_4 = log((13670358 - 273142 + 0.5) / (273142 + 0.5), 10)
    idf_ele_5 = log((13670358 - 0 + 0.5) / (0 + 0.5), 10)
    idf_ele_6 = log((13670358 - 0 + 0.5) / (0 + 0.5), 10)

    idf_eleM_1 = log((25389659 - 2143210 + 0.5) / (2143210 + 0.5), 10)
    idf_eleM_2 = log((25389659 - 491225 + 0.5) / (491225 + 0.5), 10)
    idf_eleM_3 = log((25389659 - 3307442 + 0.5) / (3307442 + 0.5), 10)
    idf_eleM_4 = log((25389659 - 268832 + 0.5) / (268832 + 0.5), 10)
    idf_eleM_5 = log((25389659 - 28853 + 0.5) / (28853 + 0.5), 10)
    idf_eleM_6 = log((25389659 - 12947 + 0.5) / (12947 + 0.5), 10)
    ...
    idf_eleK_4 = log((5435471 - 0 + 0.5) / (0+ 0.5), 10)
    ...
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                for key in wordfreq:
                    key1 = cop.sub('', key)
                    if 'q171' in key1:
                        q171_score = q171_score + wordfreq[key]
                for key in wordfreq:
                    key1 = cop.sub('', key)
                ...
                if len(breast) != 0 and breast[0]:
                        for ele in ChemicalNameList:
                            if 'Q171' in ele['NameOfSubstance']:
                                gx1 = idf_q171
                                break
                if len(breast) != 0 and breast[0]:
                        for ele in ChemicalNameList:
                ...
                if len(breast) != 0 and breast[0]:
                        for eleM in MeshHeadingNameList:
                            if 'Q171' in eleM['MeshHeadingName']:
                                gx1 = idf_q171
                                break
                if len(breast) != 0 and breast[0]:
                        for eleM in MeshHeadingNameList:
                ...
                bm25_q171_score = (((k1 + 1) * q171_score) / ((k1 * (b1 + (1 - b1) * (len_freq / 83))) + q171_score))
                bm25_amplification_score = (((k1 + 1) * amplification_score) / ((k1 * (b1 + (1 - b1) * (len_freq / 83))) + amplification_score))

                bm25_ab_score = idf_breast * bm25_breast_score + idf_fgfr1 * bm25_fgfr1_score + idf_pten * bm25_pten_score + idf_q171 * bm25_q171_score + idf_amplification * bm25_amplification_score

                idf_para = [{str(breast_score): idf_breast}, {str(fgfr1_score): idf_fgfr1},
                            {str(pten_score): idf_pten}, {str(q171_score): idf_q171}, {str(amplification_score): idf_amplification}]
                ...
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                    if 'Cell' in ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_4
                        break
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                    if 'Mastectomy' in ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_5
                        break
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                    if 'Segmental' in ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_6
                        break
                for eleM in MeshHeadingNameList:
                    if 'Gene' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_1
                        break
                for eleM in MeshHeadingNameList:
                    if 'Carcinoma' in eleM['MeshHeadingName']:
                        ...
                        break
                for eleM in MeshHeadingNameList:
                    if 'Cell' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_3
                        break
                for eleM in MeshHeadingNameList:
                    if 'Breast Neoplasms' in eleM['MeshHeadingName']:
                        ...
                        break
                for eleM in MeshHeadingNameList:
                    if 'Mastectomy' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_5
                        break
                for eleM in MeshHeadingNameList:
                    if 'Segmental' in eleM['MeshHeadingName']:
                        ss2 = ss2 + idf_eleM_6
                        break
                for eleM in MeshHeadingNameList:
