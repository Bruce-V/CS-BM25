...
mytopicdb=myclient["cs2017_27"]
mydata=mytopicdb["cs2017_score_27"]#按词表长度改进过后的2次排序表
mycount = mytopicdb["cs2017_score_27_related"]#聚类后对应与主题相关联的文献
...
def sortsecond(myfreq,mydata,yuzhi):
    ...
    idf_ele_6 = log((13670358 - 9122 + 0.5) / (9122 + 0.5), 10)
    idf_ele_7 = log((13670358 - 0 + 0.5) / (0 + 0.5), 10)
    idf_ele_8 = log((13670358 - 0 + 0.5) / (0 + 0.5), 10)
    idf_ele_9 = log((13670358 - 48800 + 0.5) / (48800 + 0.5), 10)

    idf_eleM_1 = log((25389659 - 0 + 0.5) / (0 + 0.5), 10)
    idf_eleM_2 = log((25389659 - 0 + 0.5) / (0 + 0.5), 10)
    idf_eleM_3 = log((25389659 - 0 + 0.5) / (0 + 0.5), 10)
    idf_eleM_4 = log((25389659 - 67099 + 0.5) / (67099 + 0.5), 10)
    idf_eleM_5 = log((25389659 - 165535 + 0.5) / (165535 + 0.5), 10)
    idf_eleM_6 = log((25389659 - 9122 + 0.5) / (9122 + 0.5), 10)
    idf_eleM_7 = log((25389659 - 12216 + 0.5) / (12216 + 0.5), 10)
    idf_eleM_8 = log((25389659 - 15106 + 0.5) / (15106 + 0.5), 10)
    idf_eleM_9 = log((25389659 - 48800 + 0.5) / (48800 + 0.5), 10)
    idf_eleM_10 = log((25389659 - 17437618 + 0.5) / (17437618 + 0.5), 10)
    idf_eleM_11 = log((25389659 - 8104149 + 0.5) / (8104149 + 0.5), 10)
    idf_eleM_12 = log((25389659 - 4029038 + 0.5) / (4029038 + 0.5), 10)
    idf_eleM_13 = log((25389659 - 2842020 + 0.5) / (2842020 + 0.5), 10)
    idf_eleM_14 = log((25389659 - 4785026 + 0.5) / (4785026 + 0.5), 10)

    idf_eleK_1 = log((5435471 - 430 + 0.5) / (430 + 0.5), 10)
    idf_eleK_2 = log((5435471 - 1503 + 0.5) / (1503 + 0.5), 10)
    idf_eleK_3 = log((5435471 - 924 + 0.5) / (924 + 0.5), 10)
    for x in myfreq.find({}, {'PMID', 'wordfreq', 'ChemicalNameList', 'MeshHeadingNameList', 'KeywordsList'},
        ...
        if int(x['PMID']) <= 27868941:
                ...
                bm25_ab_score = idf_pancreatic * bm25_pancreatic_score + idf_adenocarcinoma * bm25_adenocarcinoma_score + idf_kras * bm25_kras_score+idf_tp53*bm25_tp53_score

                idf_para = [{str(pancreatic_score): idf_pancreatic}, {str(adenocarcinoma_score): idf_adenocarcinoma},
                            {str(kras_score): idf_kras},{str(tp53_score): idf_tp53}]
                for ele in ChemicalNameList:
                ...
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                    if 'Pancreatic Carcinoma' in ele['NameOfSubstance']:
                        ss1 = ss1 + idf_ele_3
                        break
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
                    if 'Pancreatic Neoplasms' in ele['NameOfSubstance']:
                        ss1 = ss1 +idf_ele_4
                        break
                for ele in ChemicalNameList:
                    # if re.findall(r'(BRAF|Proto-Oncogene Proteins B-raf|human|humans|male)',ele['NameOfSubstance']):
